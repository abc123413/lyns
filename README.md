<p align="center">
  <img src="web/public/logo.svg" width="96" alt="lyns logo">
</p>

<h1 align="center">灵思 (Lyns)</h1>

<p align="center">
  <a href="https://render.com/deploy?repo=https://github.com/abc123413/lyns"><img src="https://img.shields.io/badge/Render-Deploy-46e3b7?style=flat-square&logo=render&logoColor=111111" alt="Deploy to Render"></a>
...
灵思是一款面向图片创作的开源工作台。它把画布编排、AI 图片生成、参考图编辑和对话助手放在同一个界面里，适合用来探索视觉方案并连续迭代图片结果。
...
- AI 创作：浏览器前台直连你配置的 OpenAI 兼容接口，支持文生图、图生图、参考图编辑、文本问答。
- 画布助手：围绕选中节点和上游节点对话、生图，并把结果插回画布。
- 本地 Agent：通过本机 Canvas Agent 连接 Codex / Claude Code，让 Agent 通过 MCP 操作当前画布。

完整功能说明见 [功能介绍](docs/content/docs/overview/features.mdx)。

如果你在为担心没有合适的生图API来发愁，可以查看该免费生图项目：[chatgpt2api](https://github.com/abc123413/chatgpt2api)
...
```bash
git clone git@github.com:abc123413/lyns.git
cd lyns
cd web
bun install
bun run dev
...
```bash
docker build -t lyns .
docker run --rm -p 3000:3000 lyns
```
...
<a href="https://ifdian.net/a/abc123413">
...
<a href="https://www.star-history.com/?repos=abc123413%2Flyns&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=abc123413/lyns&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=abc123413/lyns&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=abc123413/lyns&type=date&legend=top-left" />
 </picture>
</a>
