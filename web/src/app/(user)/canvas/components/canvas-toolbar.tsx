...
import { Eraser, Hand, Image as ImageIcon, Info, Moon, Palette, Redo2, Settings2, Sun, Trash2, Type, Undo2, Upload } from "lucide-react";
        ...
        <div className="pointer-events-none absolute bottom-5 z-50 flex justify-center" style={{ left: 300, right: 16 }}>
            ...
            {appearanceOpen ? (
                ...
                >
                    ...
                    <div className="mt-3 px-1 pb-1.5 text-[11px] font-medium opacity-50">纸张风格</div>
                    <Segmented
                        ...
                        options={[
                            { value: "white-paper", label: "白纸" },
                            { value: "kraft", label: "牛皮纸" },
                            { value: "dark-canvas", label: "深色" },
