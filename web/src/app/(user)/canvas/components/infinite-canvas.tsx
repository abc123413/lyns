...
import { canvasBackgroundStyle, canvasThemes, type CanvasBackgroundMode } from "@/lib/canvas-theme";
...
export function InfiniteCanvas({ containerRef, viewport, backgroundMode = "white-paper", onViewportChange, onCanvasMouseDown, onCanvasDeselect, onContextMenu, onDrop, children }: InfiniteCanvasProps) {
...
function CanvasGrid({ viewport, mode }: { viewport: ViewportTransform; mode: CanvasBackgroundMode }) {
    const bgStyle = canvasBackgroundStyle(mode);
    return (
        <div
